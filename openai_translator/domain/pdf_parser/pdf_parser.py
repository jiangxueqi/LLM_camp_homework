...
from domain.pdf_parser.content.image import Image, IMAGE_SAVE_DIR
...
class PdfParser(object):
    ...
    def parse_pdf(self):
        with pdfplumber.open(self.file_path) as pdf:
            ...
            for pdf_page in pdf.pages:
                page = Page()
                page.add_contents(self.format_page_contents(pdf_page))
                self.page_list.append(page)

    def format_page_contents(self, pdf_page):
    ...
    def format_image_contents(self, pdf_page):
        ...
        for index, img in enumerate(pdf_page.images):
            ...
            raw_image_content = {"image_name":image_name, "top":top, "width":width, "height":height}
    ...
    def _save_image(self, im, image_name):
        ...
        image_path = os.path.abspath(os.path.join(IMAGE_SAVE_DIR, image_name))
        im.save(image_path)
